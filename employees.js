...
//CODE HERE
const empTwo= {...empOne, name: `Nick`}; //dot notation is empTwo.name = 'Nick', would have to reassign in a new line?;
console.log(empTwo); 
...
const managerOne= new Manager(`Steve`, `2 to 5`, [`Jessica`]) //why can Jessica be added in brackets or not, but when adding two names you need brackets? 
console.log(managerOne.employees); 
...
//CODE HERE 
managerOne.addEmployee([`Elaine Smith`, `Jason Masterson`]) //if I add Elaine and Jason without the [] it only adds Elaine. If I treat the whole thing like another array, it doesn't. Why? 
